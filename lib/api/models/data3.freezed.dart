...
mixin _$Data3 {
 ...
 String get id; String get name; Status3 get status;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Data3&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.status, status) || other.status == status));
}
...
@override
String toString() {
  return 'Data3(id: $id, name: $name, status: $status)';
}
...
@useResult
$Res call({
 String id, String name, Status3 status
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  Status3 status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Data3() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  Status3 status)  $default,) {final _that = this;
switch (_that) {
case _Data3():
return $default(_that.id,_that.name,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  Status3 status)?  $default,) {final _that = this;
switch (_that) {
case _Data3() when $default != null:
return $default(_that.id,_that.name,_that.status);case _:
  return null;
...
class _Data3 implements Data3 {
  const _Data3({required this.id, required this.name, required this.status});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Data3&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.status, status) || other.status == status));
}
